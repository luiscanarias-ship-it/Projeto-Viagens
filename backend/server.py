...
from routes.ambassador_routes import router as ambassador_router
...
# Sponsor links + Ambassador system + Certification moved to routes/ambassador_routes.py
...
# Public ambassador profile moved to routes/ambassador_routes.py
...
# Admin stats moved to routes/admin_routes.py
...
# Site settings moved to routes/admin_routes.py

# Dreamers stats moved to routes/admin_routes.py

# Admin user management, email routes, gallery moved to routes/admin_routes.py
