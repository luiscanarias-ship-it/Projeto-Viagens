...
FRONTEND_URL = "https://crypto-payments-23.preview.emergentagent.com"
...
async def create_subscription_checkout(request: Request):
    ...
    frontend_url = os.environ.get('FRONTEND_URL', 'https://crypto-payments-23.preview.emergentagent.com')
