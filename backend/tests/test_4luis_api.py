...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://travel-celebrate.preview.emergentagent.com').rstrip('/')
    ...
    def test_create_stripe_checkout(self, auth_token):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://travel-celebrate.preview.emergentagent.com"
            },
            headers={"Authorization": f"Bearer {auth_token}"}
        )
        assert response.status_code == 200
