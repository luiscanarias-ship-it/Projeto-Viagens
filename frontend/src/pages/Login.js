...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dream-mesh px-6 py-8" data-testid="login-page">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        {/* Logo — compact */}
        <Link to="/" className="flex items-center justify-center gap-1.5 mb-3">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-lg border border-stone-100">
          <h1 className="text-base font-bold text-center mb-0.5" data-testid="auth-title">
          ...
          <button onClick={() => loginWithGoogle()}
            className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-xl border-2 border-stone-200 hover:border-stone-300 transition-colors mb-3 text-xs"
            ...
            <span className="font-medium text-xs">{t('auth.google')}</span>
          </button>
          ...
          <p className="text-center text-[10px] text-[#6B6661] mt-3">
