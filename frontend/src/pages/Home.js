    ...
    <div className="min-h-screen" data-testid="home-page">
      ...
      <AnimatePresence>
        {showStickyBar && mainJourney?.journey && !showCheckout && (
          ...
          >
            <div className="max-w-5xl mx-auto px-4 md:px-6 pr-[200px] py-3 flex items-center gap-3 md:gap-5">
              ...
              <button
                onClick={() => setShowCheckout(true)}
                className="w-full sm:w-auto sm:mr-auto py-3 px-6 bg-[#FFBE98] text-[#2D2A26] rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#FFAB7D] transition-colors"
